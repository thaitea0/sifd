          ...
          <div class="card">
            ...
            <div class="chat-box">
              <div class="card-body chat-content">
                  ...
                  <?php } ?>
                      ...
                      <div class="chat-details">
                        ...
                        <?php }else{ ?>
                            <div class="chat-text" style="background-color: lightgrey;color: #788695;"><i class="fas fa-ban"></i> <i>Komentar ini telah di nonaktifkan</i></div>
                        <?php } ?>
              ...
              <div class="card-footer chat-form">
                ...
                <?php }else{ ?>
                  <form action="{{url('/add_komen')}}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                      @foreach($idk as $id)
