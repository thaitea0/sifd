        ...
        <div class="form-inline mr-auto">
          <ul class="navbar-nav mr-3">
            ...
            <li>
              ...
              <a href="#" class="nav-link nav-link-lg" style="color: black;"><i data-feather="map-pin"></i> Dusun {{Session::get('dusun')}} RW {{Session::get('rw')}}</a>
            </li>
          </ul>
        </div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="/ketuarw"> <img alt="image" src="assets/img/logo.png" class="header-logo" /> <span
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalCenterTitle">Edit {{$ed->NAMA}}</h5>
            </div>
            <?php 
                $id = $ed->PENG_ID;
            ...
            ?>
            @foreach($edit as $upd)
            <form action="/karw:upd={{$upd->PENG_ID}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
