        ...
        <div class="form-inline mr-auto">
          <ul class="navbar-nav mr-3">
            ...
            <li>
              ...
              <a href="#" class="nav-link nav-link-lg" style="color: black;"><i data-feather="map-pin"></i> Dusun {{Session::get('dusun')}} RW {{Session::get('rw')}} RT {{Session::get('rt')}} </a>
            </li>
          </ul>
        </div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="/ketuart"> <img alt="image" src="assets/img/logo.png" class="header-logo" /> <span
      ...
      <div class="modal fade" id="editPengguna{{$ed->PENG_ID}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
          <div class="modal-content">
            ...
            ?>
            @foreach($edit as $upd)
            <form action="/kart:upd={{$upd->PENG_ID}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
