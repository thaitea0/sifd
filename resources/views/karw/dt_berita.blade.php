@extends('layout.laykrw')

@section('menu')
  <ul class="sidebar-menu">
    <li class="menu-header">Main</li>
    <li class="dropdown">
      <a href="/ketuarw" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
    </li>
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        @foreach($katb as $kb)
        <li><a class="nav-link" href="/beritarw:kat={{$kb->JENIS_KAT}}"> Berita {{$kb->JENIS_KAT}} </a></li>
        @endforeach
      </ul>
    </li>
  </ul>
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td style="width: 150px;">
                              ...
                              <a href="/beritart:del={{$dat->BERITA_ID}}" class="btn btn-outline-danger btn-icon" onclick="return(confirm('Anda Yakin ?'));"><i class="fas fa-trash"></i></a>
                          </td>
                      </tr>
                      @endforeach
                  </tbody>
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
      <div class="modal-content">
        ...
        <form action="{{url('/add_beritarw')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
  ...
  <div class="modal fade" id="editBerita{{$ed->BERITA_ID}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
      <div class="modal-content">
        ...
        ?>
        @foreach($upd as $upd)
        <form action="/beritarw:upd={{$ed->BERITA_ID}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="modal-body">
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="far fa-times-circle"></i> Batal</button>
                <button  class="btn btn-primary"><i class="far fa-edit"></i> Ubah</button>
            </div>
        </form>
        @endforeach
      </div>
