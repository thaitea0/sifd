...
@section('menu')
  <ul class="sidebar-menu">
    ...
    <li class="dropdown">
      <a href="/databeritarw" class="nav-link"><i data-feather="bookmark"></i><span>Data Berita</span></a>
    </li>
                      ...
                      <div class="chat-details">
                        ...
                        <?php }else{ ?>
                            <?php if ($ch->STATUS == 'Aktif'){?>
                                <div class="chat-text">{{$ch->KOMEN}}</div>
                                <a href="/komenrw:non={{$ch->KOMEN_ID}}" class="btn btn-danger btn-icon btn-sm" style="margin-left: 8px;"><i class="fas fa-times-circle"></i></a>
                          <?php }else{ ?>
                                <div class="chat-text" style="background-color: lightgrey;color: #788695;">{{$ch->KOMEN}}</div>
                                <a href="/komenrw:akt={{$ch->KOMEN_ID}}" class="btn btn-success btn-icon btn-sm" style="margin-left: 8px;"><i class="fas fa-check-circle"></i></a>
                        <?php } } ?>
