          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <article class="article article-style-b" style="border-radius: 30px 0px 30px 0px;">
              ...
              <div class="article-details"  style="border-radius: 30px 0px 30px 0px;">  
                <span style="text-align:left;">Berita RT {{$ber->RT}}</span> 
                <p>{{$ber->isi}}...</p>
                <div class="article-cta"><a href="/beritarw:chat={{$ber->BERITA_ID}}">Forum Diskusi <i class="fas fa-chevron-right"></i></a>
                </div>
              </div>
            </article>
          </div>
