  ...
  <ul class="sidebar-menu">
    ...
    <li class="dropdown active">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active"><a class="nav-link" href="/datakades">Kepala Desa</a></li>
...
@section('content')
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Kepala Desa</h5>
        </div>
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-5">
                    ...
                    <input type="hidden" name="level" value="Kepala Desa" readonly="">
                    <center>
                        FOTO<br>
  ...
  <div class="modal fade" id="infoPengguna{{$ed->PENG_ID}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Info Kepala Desa</h5>
        </div>
        <?php 
            $id = $ed->PENG_ID;
  ...
  <div class="modal fade" id="editPengguna{{$ed->PENG_ID}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Edit Kepala Desa</h5>
        </div>
        <?php 
            $id = $ed->PENG_ID;
            $edit = DB::SELECT("select*from pengguna where PENG_ID = '$id'");
              ...
              <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="dusun" required="">
                            @foreach($dusun as $ds)
